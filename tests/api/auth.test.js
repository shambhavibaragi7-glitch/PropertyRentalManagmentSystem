...
describe('Auth API Endpoints', () => {
    ...
    beforeEach(() => {
        ...
        mockUsers = {
            manager: {
                ...
                password: 'ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f', // 'password123' sha256
                name: 'Manager PM-1',
    ...
    describe('POST /api/auth/login', () => {
        ...
        it('should return 401 for unregistered manager credentials', async () => {
            const res = await request(app)
                .post('/api/auth/login')
                .send({
                    role: 'manager',
    ...
    describe('POST /api/auth/register', () => {
        it('should register successfully with a valid password', async () => {
            const res = await request(app)
        ...
        it('should return 400 if password does not meet requirements', async () => {
            ...
            expect(res.status).toBe(400);
            expect(res.body.detail).toContain('Password must be exactly 8 characters long');
